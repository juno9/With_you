...
public class ConnectRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String 나의이메일 = intent.getStringExtra("나의이메일");//내 쉐어드에 접근할 키로 이메일을 받아옴
        String 상대이메일 = intent.getStringExtra("연결상대");//상대 쉐어드에 접근할 키로 이메일을 받아옴
        ...
        연결완료버튼.setOnClickListener(new View.OnClickListener() {
            ...
            String 상대제이슨바꿀스트링= 쉐어드.getString(상대이메일, "");
